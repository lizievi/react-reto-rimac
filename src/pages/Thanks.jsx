  ...
  return (
    <div>
      ...
      <section className='pt-[56px] grid grid-cols-[1fr_2fr]'>
        <img src={ImgTyMobile} alt="Imágen de agradecimiento" className='w-full  max-h-[300px] object-cover lg:hidden'/>
        ...
        <div>
          <div>
            <div className='w-[80%] lg:w-[60%] lg:ml-[15%] mx-auto py-10 text-[28px] lg:text-[36px]'>
              <h1 className='text-[var(--color-primary)] tracking-[-0.6px] lg:tracking-[-0.2px]'>
                ...
                <span className='text-[var(--color-secondary-dark)] block'>Cuenta con nosotros para proteger tu vehículo</span>              
              </h1>
            </div>
          </div>
          <div className='text-[var(--color-secondary)] !font-[var(--font-secondary)]'>
            <p className='w-[80%] mx-auto font-light lg:w-[60%] lg:ml-[15%]'> 
              ...
              <span className='font-bold block'>joel.sanchez@gmail.com</span>
            </p>
          </div>
          <div className='py-10'>
            <ButtonPrimary value='CÓMO USAR MI SEGURO' className='w-[80%] mx-auto block lg:w-fit lg:px-10 lg:py-6 lg:ml-[15%]'/>  
          </div>
        </div>
      </section>
